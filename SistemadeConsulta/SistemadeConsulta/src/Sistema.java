...
public class Sistema {
    public static void main(String args[]){
        ...
        do{
            ...
            System.out.println("1 - Adicione um cliente na fila");
            ...
            switch(escolha){
                case 1:
                    ...
                    do{
                     ...
                     do{
                        ...
                        System.out.println("3 - Outra Opereção");
                    ...
                    fl.adicionarPessoa(p1);
                    System.out.println("Pessoa adicionada na fila");
                    break;
                ...
                case 5:
                         ...
                         break;
                case 6:
                        System.out.println("Informe o interesse pra listar os clientes");
                        System.out.println("1 - Pagamento de Conta");
                        System.out.println("2 - Recebimento de Salário");
                        ...
                        if(lista.isEmpty()){
                            System.out.println("Não há clientes com esse Intresse");
                        }else{
